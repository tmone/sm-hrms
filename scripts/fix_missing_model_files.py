...
def fix_model(model_name):
    ...
    if not missing_files:
        print(f"✅ All model files already exist for: {model_name}")
        return True
    
    print(f"⚠️  Missing files for {model_name}: {', '.join(missing_files)}")
